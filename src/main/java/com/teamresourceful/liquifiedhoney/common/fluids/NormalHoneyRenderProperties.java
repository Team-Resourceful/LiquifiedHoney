package com.teamresourceful.liquifiedhoney.common.fluids;
...
public class NormalHoneyRenderProperties implements IClientFluidTypeExtensions {
    ...
    public static final ResourceLocation FLUID_STILL = new ResourceLocation(LiquifiedHoney.MOD_ID, "block/honey/honey_still");
    public static final ResourceLocation FLUID_FLOWING = new ResourceLocation(LiquifiedHoney.MOD_ID, "block/honey/honey_flow");
